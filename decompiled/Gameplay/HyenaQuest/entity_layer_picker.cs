...
public class entity_layer_picker : NetworkBehaviour
{
	...
	protected override void __initializeVariables()
	{
		if (_layer == null)
		{
			throw new Exception("entity_layer_picker._layer cannot be null. All NetworkVariableBase instances must be initialized.");
		}
