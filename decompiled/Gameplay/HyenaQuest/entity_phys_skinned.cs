...
public class entity_phys_skinned : entity_phys
{
	...
	protected override void __initializeVariables()
	{
		if (_skin == null)
		{
			throw new Exception("entity_phys_skinned._skin cannot be null. All NetworkVariableBase instances must be initialized.");
		}
